...
export default function Cardlist() {
    const { cardList, setCardList, turns, setTurns, newgame } = useCardListContext();
    ...
    useEffect(() => {
        ...
        if (turnCount === 2) {
            ...
            if (isMatch) {
                ...
                setTurnCount(0);
                setTimeout(() => {
                    if (!newCardList.some((card) => !card.isOpened) && window.confirm("You Win!!, Do you like to restart the game?")) {
                        newgame();
                    }
                }, 1000)
            } else {
    ...
    }, [turnCount, cardList, setCardList, setTurnCount, newgame])
